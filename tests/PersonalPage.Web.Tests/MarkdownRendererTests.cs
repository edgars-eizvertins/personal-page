...
public class MarkdownRendererTests
{
    ...
    {
        var result = _renderer.Render("## Notes\n\ntext\n\n## Notes\n\nmore\n");

        var ids = result.Headings.Select(h => h.Id).ToList();
    ...
    [Fact]
    public void Headings_are_collected_with_their_final_level_and_text()
    {
        var result = _renderer.Render("# One\n\n## Two\n");

        Assert.Collection(result.Headings,
            first =>
            {
    ...
    {
        var html = _renderer.Render("![alt](/media/x.png)").Html;
    ...
    {
        var html = _renderer.Render("![alt](/media/x.png){width=800 height=450}").Html;
    ...
    public void Raw_html_in_the_body_survives_to_the_output()
    {
        ...
        var html = _renderer.Render("<figure><img src=\"/media/x.png\"><figcaption>Hi</figcaption></figure>").Html;
    ...
    {
        Assert.Equal(string.Empty, _renderer.Render("   ").Html);
    }
}
